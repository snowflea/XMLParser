...
if __name__ == "__main__":
    if os.getuid() != 0:
    	...
    	VMName="iaasvmcontainerv2;AAD-INNOVATION-RG;aad-cots-linux-vm"
    	MachineName="aad-cots-linux-vm"
    	TargetPortalAddress="pod01-rec2.cnc.backup.windowsazure.com"
    	TargetPortalPortNumber="3260"
    	TargetNodeAddress="iqn.2016-01.microsoft.azure.backup:4573254253517469727-53592-6309560670608627171-6309668199440678645.637194315584439138"
    	InitiatorChapPassword="d694cc10c4950f"
    	ScriptId="a32608b4-1d1c-4146-8459-d8cb50a6af21"
    	TargetUserName="4573254253517469727-cc0cc059-0b00-4cea-ae35-ed0b9c050805"
